...
void MuonPMTHit(){
  ...
  //c1->SetLogy();
  c1->cd(); 
  ch.Draw("NbOfPMTHits>>hNPE18","(PMTHits->pmtNumber==18)");
  ch.Draw("NbOfPMTHits>>hNPE19","(PMTHits->pmtNumber==19)","same");
  ch.Draw("NbOfPMTHits>>hNPE20","(PMTHits->pmtNumber==20)","same");
  ch.Draw("NbOfPMTHits>>hNPE21","(PMTHits->pmtNumber==21)","same");
